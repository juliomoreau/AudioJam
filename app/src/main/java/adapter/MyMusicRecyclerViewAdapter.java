...
import com.example.jules.audiojam.ListFragment.OnListFragmentInteractionListener;
...
public class MyMusicRecyclerViewAdapter extends RecyclerView.Adapter<MyMusicRecyclerViewAdapter.ViewHolder> {
    ...
    public MyMusicRecyclerViewAdapter(List<Music> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
