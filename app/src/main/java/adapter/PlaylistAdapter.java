...
public class PlaylistAdapter extends BaseAdapter {
    ...
    public boolean addPlaylistToList(Playlist item) {
        items.add(item);
        return true;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        delete.setImageResource(R.drawable.choosecover);
        settings.setImageResource(R.drawable.choosecover);
        addadmin.setImageResource(R.drawable.choosecover);
